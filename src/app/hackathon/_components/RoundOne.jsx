...
function RoundOne({ theme_val, theme, problem_val, problem, next }) {
  ...
  return (
    <div>
      <div className="w-full overflow-hidden overscroll-x-none h-[100vh]  bg-[rgb(10,17,58)]">
        <div className="font-poppins text-black mx-auto">
          <div className="overflow-hidden overscroll-x-none  bg-gradient-to-r from-cyan-500 z-0 to-blue-500 md:w-[70%] sm:w-[60%] lg:w-[63%] xl:w-[55%] p-8 rounded-[50%] h-[80%] left-[25%] top-[50px] md:left-[17%] md:top-[40px] lg:left-[19%] xl:left-[23%] absolute blur-3xl levitate"></div>
          <div className="bg-white relative z-10 sm:w-[90%] md:w-[650px] h-fit  bg-opacity-80  px-5  md:px-8 py-8 rounded-xl sm:mx-auto top-[150px]">
            ...
            <div className="border-slate-500 rounded border-2 border-dashed w-full h-full sm:px-4 mx md:px-10 mt-3 py-8">
              ...
              <select
                value={theme_val}
                className="w-full p-3 rounded border-2 mx-auto bg-transparent border-black mt-3"
              ...
              <div className="w-full flex justify-center mt-5">
                ...
                <Button
                  ...
                  disabled={theme == -1 || theme=="" || problem_val=="" || problem_val==null }
                >
