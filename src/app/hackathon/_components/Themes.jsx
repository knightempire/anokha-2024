  ...
  const themes = [
    ...
    },
    {
      ...
      problemStatements: [
        ...
        ["Smart Retail Inventory Management","In the era of smart retail, the challenge is to develop an innovative inventory management system that leverages the power of IoT and AI. The goal is to create a solution that not only monitors product levels but also predicts demand, optimizes restocking schedules, and minimizes the risk of overstocking or stockouts. Additionally, the system should enhance the overall user experience through a user-friendly interface."],
        ["Other Problem Statements","Participants are free to choose any AI/ML related problem statement which comes under this theme."]
      ],
    },
    {
