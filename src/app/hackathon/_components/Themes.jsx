...
const Themes = () => {
  return (
    <div className='font-poppins h-[100%]'>
      {/*<div className='font-bold w-full text-[3rem] ml-[250px] mt-10'>Themes</div>*/}
      <div className='bg-indigo-500 w-[45%] mx-auto rounded-[15px] my-20'>
        <img src={theme1} className='h-[250px] object-cover w-full rounded-t-[15px]'/>
