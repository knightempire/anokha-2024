...
export function SimpleCard() {
  return (
    <Card className="mt-10 sm:w-[200px] md:mx-auto md:w-full rounded-lg shadow-lg bg-white mx-6 ls:w-[400px]">
      <CardBody className="p-6 sm:w-[200px] md:w-[400px] lg:w-[600px] h-full">
