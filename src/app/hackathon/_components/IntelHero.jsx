    ...
    <div className="w-[100%] overscroll-x-none h-[100vh] bg-[rgb(10,17,58)]">
      <div className="font-poppins text-black mx-auto">
        ...
        <div className="bg-white md:w-[40%] bg-opacity-80 sm:w-[93%] px-10 py-12 rounded-xl sm:mx-auto lg:top-[30%] md:top-[30%] sm:top-[37.5%] lg:left-[30%] md:left-[27%] sm:left-[3%] absolute">
          ...
          />
          <p className="md:text-[3rem] sm:text-[2rem] font-bold sm:leading-[100%] mt-2 relative">
            Intel AI Hackathon
          </p>
          <div className="text-xs w-fit py-2 bg-blue-500 px-4 mt-2 rounded-full text-white flex items-center gap-1 relative">
          ...
          <div className="flex md:gap-4 sm:gap-2 flex-wrap mt-2 relative">
            <Button
              onClick={(e) => {
                router.replace("/hackathon/instructions");
              }}
            ...
            {userState === 0 ? (
              ...
              <Button
                onClick={(e) => {
                  router.replace("/hackathon/register");
                }}
