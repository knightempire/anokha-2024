  ...
  return (
    <div>
      <div className="font-poppins h-full w-full py-5 mt-10 text-black">
            ...
            <ol className= "md:flex px-[10%] py-2 h-full">
                <li className="relative mb-6 sm:mb-0 h-full">
                        ...
                        <div className="md:mt-3 sm:mt-3 sm:mb-10 sm:pe-8 max-w-[400px] mx-auto h-full">
                            <p className ='text-[2rem] font-bold text-center'>Phase 1</p>
                            <p className='text-lg font-bold mb-3 text-center'>Ideation</p>
                            <div className='bg-[#017DC5] p-5 h-full rounded-lg text-white'>
                    ...
                    <li className="relative mb-6 sm:mb-0 h-full">
                        ...
                        <div className="md:mt-3 sm:mt-3 sm:mb-10 sm:pe-8 max-w-[400px] mx-auto h-full">
                            <p className ='text-[2rem] font-bold text-center'>Phase 2</p>
                            <p className='text-lg font-bold mb-3 text-center'>Prototype Development</p>
                            <div className='bg-[#017DC5] p-5 rounded-lg text-white h-full'>
