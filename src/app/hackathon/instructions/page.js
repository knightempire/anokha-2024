...
const Home = () => {
  return (
    ...
    <div className="font-poppins text-white mx-auto text-center">
        ...
        <div className="bg-gradient-to-r from-cyan-500 to-blue-500 md:w-[50%] p-8 rounded-[50%] lg:h-[60%] md:h-[40%] sm:h-[25%] lg:left-[25%] sm:left-[12%] md:left-[23%] lg:top-[20%] md:top-[30%] sm:top-[35%] absolute blur-3xl levitate sm:w-[80%]"></div>
