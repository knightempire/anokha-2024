...
const Home = () => {
  ...
  return (
    <div className="">
      <Navigationbar />
      {/* <Instructions/> */}
      <div className="w-full h-screen  relative flex flex-col justify-center items-center bg-[#0A113A] pb-6">
        <div className="font-poppins text-white ml-auto mr-auto lg:mt-[4%] md:mt-[10%] sm:mt-[25%] text-center">
          <h1 className="text-4xl font-black ">INSTRUCTIONS</h1>
          <p className="text-lg mb-8">Follow these steps to get started</p>
          <div className="bg-gradient-to-r from-cyan-500 to-blue-500 md:w-[40%] p-8 rounded-[50%] lg:h-[60%] md:h-[30%] sm:h-[25%] lg:left-[30%] sm:left-[12%] md:left-[20%] lg:top-[30%] md:top-[30%] sm:top-[35%] absolute blur-3xl levitate sm:w-[80%]"></div>
          <div className="md:px-0 sm:px-[2%]">
            <SimpleCard />
          </div>
