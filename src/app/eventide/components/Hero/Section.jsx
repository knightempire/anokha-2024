...
const Section = () => {
    ...
    const etext2="Get ready for a night of pure musical magic at the Proshow, the showstopper of Anokha Techfest 2024! This year, we’re bringing the electrifying energy of the legendary keytar maestro Stephen Devassy, alongside the soul-stirring voice of Satyaprakash and their powerhouse group, The Solid Band. Known for blending Indian classical, jazz, and rock, their musical brilliance is truly one of a kind! With foot-tapping beats and melodies that touch your heart, this concert will leave you craving more."
    ...
    <div className="h-[500px] overflow-hidden">
        <Image src="https://i.imgur.com/d2ReTJe.jpg" alt="Performance image 4" layout="responsive" width={500} height={200} />
                ...
                <div className="max-md:hidden text-4xl md:text-7xl text-neutral-600 flex items-center font-extrabold">GRACEFUL EXPRESSIONS...</div>
                <motion.div variants={item}>
                ...
                <motion.div variants={image} className="md:mt-[40px]">
                    <Image src="/images/Sarnesh_62.jpg" alt="Performance image 2" layout="responsive" width={500} height={500} />
                </motion.div>
