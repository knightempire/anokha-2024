    ...
    <div class="bg-[rgba(0,0,0,0.3)] backdrop-blur-lg min-h-[600px] shadow-lg rounded-xl p-4 border-2 border-transparent hover:border-2 hover:border-orange-400 transition duration-150 overflow-hidden shiny">
      ...
      <div class="flex-auto justify-between flex flex-col">
        <div class="flex flex-wrap items-center justify-between">
          <h1 class="text-2xl cursor-pointer text-gray-200 hover:text-orange-400 break-word">
            {eventName}
          </h1>
          <button
            onClick={handleStarToggle}
            id="heartButton2"
            class="transition ease-in duration-300 bg-gray-800 hover:text-orange-400 shadow hover:shadow-md text-gray-500 rounded-full w-8 h-8 text-center p-1"
          >
            <svg
              id="heartSVG2"
              class="h-6 w-6"
            ...
            {tags.map((tag, index) => {
              return (
                <div
                  ...
                  class="flex items-center text-xs px-2 py-1 mr-2 mb-2 transition-200 rounded-xl bg-black text-white border-[2px] border-orange-400"
                >
