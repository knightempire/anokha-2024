...
export default function PaymentFailure() {
    ...
    return (
        ...
        <div className="text-[#04002a] items-center justify-center mx-auto my-auto bg-white rounded-3xl px-8 py-8 z-10">
                ...
                <h1 className="text-center justify-center text-4xl font-bold">Payment Failed</h1>
                <p className="text-gray-700 text-sm text-center">Please try again later after sometime.</p>
