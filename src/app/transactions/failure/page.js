...
export default function PaymentFailure() {
  ...
  return (
    <main className="flex min-h-screen flex-col bg-[#192032]">
      ...
      <div className="text-[#04002a] items-center justify-center my-auto md:mx-auto bg-white rounded-3xl px-8 py-8 z-10 sm:scale-75 md:scale-90 lg:scale-100 xl:scale-100 2xl:scale-110">
        <>
