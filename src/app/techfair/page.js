    ...
    <>
      <main className="flex min-h-screen bg-[#192032] font-roobert text-md overflow-x-hidden">
        ...
        <div className="flex z-20 w-full flex-col">
          ...
          <div className="bg-[rgba(0,0,0,0.3)] backdrop-blur-lg flex z-19 flex-col justify-center items-center p-8 m-8 rounded-2xl ml-auto mr-auto sm:w-[90%] lg:w-[70%]">
            <div className="text-white text-4xl m-4 mb-8">About</div>
            <div className="text-white rounded-2xl text-md text-center sm:w-full mb-4">
          ...
          <div className="flex flex-col justify-center items-center sm:p-4 sm:m-4 md:p-8 md:m-8 rounded-2xl">
            <div className="min-h-[200px] bg-[rgba(0,0,0,0.3)] backdrop-blur-lg text-center items-center py-5 ml-auto mr-auto rounded-2xl lg:w-[80%]" >
              <h2 className="mt-4 sm:text-3xl lg:text-4xl text-white mb-8">
                Submit Your Projects
              </h2>
              <div className="mx-auto my-4 p-4 text-white text-md">
            ...
            <div className="text-white text-4xl m-4 mt-32 text-center">Benefits of Participating</div>
