  ...
  <div className="container mx-auto flex xl:flex-row lg:flex-row md:flex-row sm:flex-col justify-between items-center ">
    <div className="relative xl:h-screen lg:h-screen md:h-[80vh] sm:h-[60vh] flex items-center container sm:w-full">
      <section className="mx-4 md:mx-16 cursor-default">
        ...
        <h2 className="text-6xl font-spincycle tracking-widest md:text-7xl lg:text-8xl xl:text-9xl font-semibold mt-6 text-orange-500 font-family: Spin-cycle">
          anokha
        </h2>
        <h2 className="text-6xl font-spincycle tracking-widest md:text-7xl lg:text-8xl xl:text-9xl font-semibold text-orange-500 font-family: Spin-cycle">
          2024
        </h2>
