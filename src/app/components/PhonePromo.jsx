  ...
  return (
    <div className='px-10 pt-10 z-10 md:flex justify-center gap-[60px] mx-auto w-full'>
      ...
      <h1 className='text-bold md:text-[3rem] sm:text-3xl'>Anokha 2024 in Your Pocket!
        ...
        <Link href="https://play.google.com/store/apps/details?id=com.vaisakhkrishnank.anokha_home"><Image src="/images/getonplaystore.png" className='mt-5' width={200} height={100} alt='Download from Google Play Store button.'/></Link>
